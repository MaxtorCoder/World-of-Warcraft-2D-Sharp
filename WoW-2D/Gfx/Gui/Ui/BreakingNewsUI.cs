...
namespace WoW_2D.Gfx.Gui.Ui
{
    ...
    public class BreakingNewsUI : UiControl
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                var text = GfxManager.Wrap(GfxManager.GetFont("small_font"), Global.BreakingNewsText, breakingNewsBox.Width);
                ...
                spriteBatch.DrawString(GfxManager.GetFont("main_font"), breakingNews, new Vector2(breakingNewsBox.Position.X + (breakingNewsBox.Width / 2), breakingNewsBox.Position.Y + 10f), GfxManager.DefaultYellow, 0f, new Vector2(GfxManager.GetFont("main_font").MeasureString(breakingNews).Width / 2, 0f), 1f, SpriteEffects.None, 0f);
